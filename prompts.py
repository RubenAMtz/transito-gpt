...
class PromptBuilder:
    ...
    def _section_length_controller(self, documents_section: Union[str,list[str]], max_section_length: int, separator: str) -> str:
        ...
        chosen_sections = []
        # used to find the chosen documents
        chosen_sections_raw = []
        ...
        if isinstance(documents_section, str):
            ...
            for document in documents_section:
                ...
                chosen_sections_raw.append(document)
                chosen_sections.append(separator + document.replace("\n", " "))
                
            # search for the document in self.relevant_documents using the raw document's text
            for chosen_document in chosen_sections_raw:
